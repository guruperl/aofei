...
if ! grep -Eq '^\| P03 .* \| Completed; disabled by default \|' docs/README.md; then
	fail "docs/README.md must identify P03 as completed and disabled by default."
fi

if ! grep -Eq '^\| S05 .* \| Completed \|' docs/README.md; then
...
if ! grep -Eq '^\| A03 .* \| Completed \|' docs/README.md; then
	fail "docs/README.md must identify A03 as completed remediation."
fi
