...
| Middleman callback context | Selected external bid | Proxy downstream callbacks and reconcile charge/pay facts | Redis token context; contains transaction and price metadata, not raw user identity | `middleman_callback_ttl_seconds`, default 24 hours |
