...
[% SET item=edit.0 %]
<h3 class="curTitle">[% item.campaignname %] <a href="javascript:window.history.back()"><img src="/uilib/comImg/back.png" border=0 width="25" height="25" /></a></h3>

    <div id="container">
    <div id="mainmenu">
					<ul id="tabs">
						<li>
							<a href="#compaignEdit">[% item.campaignname %]</a>
						</li>
					</ul>
		<div>
		<form class=jqtransform method=post action=campaign>
				<div class="bar">&nbsp;</div>
				<div class="panel" id="compaignEdit">
...
<tr>
  <td>Access Order:</td>
  <td>
    <select id="accessorder" name="accessorder" multiple="true" class="multiSelectBox">
...
<tr>
  <td>Status:</td>
  <td>
    <select id="status" name="status" multiple="true" class="multiSelectBox">
...
<tr><td colspan=2> &nbsp; </td></tr>
  ...
  </div><!-- end <div class="panel" id="[% item.campaignname %]"> -->
