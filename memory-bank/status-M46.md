...
| Creative-boundary and validation clarity | `[ ]` | Preserve supported scripts and sandbox containment while removing sanitizer-like claims; simplify direct-publisher validation. |
