...
CREATE TABLE `adv_item` (
  ...
  `created` datetime DEFAULT NULL,
  `qa_mime` enum('XHTMLText','XHTMLBanner','JSMime','Iframe','MimeUnknown') DEFAULT 'Iframe',
  PRIMARY KEY (`item_id`),
  KEY `size_id` (`size_id`),
...
CREATE TABLE `pub_slot` (
  ...
  `fl_mime` set('XHTMLText','XHTMLBanner','JSMime','Iframe','MimeUnknown') DEFAULT 'XHTMLText,XHTMLBanner,JSMime,Iframe,MimeUnknown',
  `created` datetime DEFAULT NULL,
  `active` enum('Yes','No','New') DEFAULT 'Yes',
