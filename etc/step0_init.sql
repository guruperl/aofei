...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_ac_insert` AFTER INSERT ON `ac` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_ac_delete` AFTER DELETE ON `ac` FOR EACH ROW BEGIN
	INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_adv` AFTER UPDATE ON `adv` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_balance` AFTER UPDATE ON `adv_balance` FOR EACH ROW BEGIN
...
CREATE TABLE `adv_campaign` (
  ...
  `qa_campaign` int unsigned DEFAULT '0',
  `fl_site` int unsigned DEFAULT '0',
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_campaign` AFTER UPDATE ON `adv_campaign` FOR EACH ROW BEGIN
  IF ((NEW.active <=> OLD.active) = 0) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_creative_insert` AFTER INSERT ON `adv_creative` FOR EACH ROW BEGIN
        INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_creative` AFTER UPDATE ON `adv_creative` FOR EACH ROW BEGIN
  IF ((NEW.active <=> OLD.active) = 0) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_creative_delete` AFTER DELETE ON `adv_creative` FOR EACH ROW BEGIN
        INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
CREATE TABLE `adv_item` (
  ...
  `cost_type` enum('CPD','CPM','CPC','CPA') DEFAULT 'CPC',
  `cost` double DEFAULT NULL,
  `total_balance_id` int unsigned DEFAULT NULL,
  `daily_balance_id` int unsigned DEFAULT NULL,
  `startx` datetime DEFAULT NULL,
  `endx` datetime DEFAULT NULL,
  `fl_language` set('English','German','French','Spanish','Chinese','Japanese','Korean','Asian','Arabian','Other') DEFAULT 'English',
  `fl_device` set('DeviceUnknown','DeviceMobile','DevicePC','DeviceTV','DevicePhone','DeviceTablet','DeviceConnected','DeviceSetTopBox') DEFAULT 'DeviceUnknown,DeviceMobile,DevicePC,DevicePhone,DeviceTablet',
  `fl_position` set('PositionUnknown','PositionAboveFold','PositionLocked','PositionBelowFold','PositionHeader','PositionFooter','PositionSideBar','PositionFullScreen') DEFAULT 'PositionUnknown,PositionAboveFold,PositionLocked,PositionBelowFold,PositionHeader,PositionFooter,PositionSideBar,PositionFullScreen',
  `fl_content` set('ContentUnknown','ContentVideo','ContentGame','ContentMusic','ContentApp','ContentText','ContentOther') DEFAULT 'ContentUnknown,ContentVideo,ContentGame,ContentMusic,ContentApp,ContentText,ContentOther',
  `qa_creative` enum('AttrUnknown','AttrAudioAuto','AttrAudioUser','AttrExpandableAuto','AttrExpandableUserClick','AttrExpandableUserRollover','AttrVideoAuto','AttrVideoUser','AttrPop','AttrProvocative','AttrExtremeAnimation','AttrSurvey','AttrTextOnly','AttrInteractive','AttrWindowsDialog','AttrHasAudioToggleButton','AttrHasSkipButton','AttrFlash','AttrResponsive') DEFAULT 'AttrUnknown',
  `active` enum('Prepare','New','Pass2','Yes','No','Pause') DEFAULT 'Prepare',
  `created` datetime DEFAULT NULL,
  `qa_mime` enum('JsonMime','H5Mime','JSMime','ImageMime','VideoMime','AudioMime','MimeUnknown') DEFAULT 'H5Mime',
  PRIMARY KEY (`item_id`),
  KEY `size_id` (`size_id`),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_item` AFTER UPDATE ON `adv_item` FOR EACH ROW BEGIN
  IF ((NEW.active <=> OLD.active) = 0) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
CREATE TABLE `adv_targetname` (
  ...
  KEY `campaign_id` (`campaign_id`),
  KEY `attrname_id` (`attrname_id`),
  CONSTRAINT `adv_targetname_ibfk_1` FOREIGN KEY (`campaign_id`) REFERENCES `adv_campaign` (`campaign_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_targetname_insert` AFTER INSERT ON `adv_targetname` FOR EACH ROW BEGIN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_chac_insert` AFTER INSERT ON `ch_ac` FOR EACH ROW BEGIN
	INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_chac_delete` AFTER DELETE ON `ch_ac` FOR EACH ROW BEGIN
	INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_belong_insert` AFTER INSERT ON `ch_belong` FOR EACH ROW BEGIN
	INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_belong_delete` AFTER DELETE ON `ch_belong` FOR EACH ROW BEGIN
	INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_payment` AFTER UPDATE ON `pay_payment` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_pub` AFTER UPDATE ON `pub` FOR EACH ROW BEGIN
...
CREATE TABLE `pub_site` (
  ...
  `qa_site` int unsigned DEFAULT '0',
  `fl_campaign` int unsigned DEFAULT '0',
  `channel_order` enum('White','Black') DEFAULT 'Black',
  `access_order` enum('White','Black','Inherit') DEFAULT 'Inherit',
  `created` datetime DEFAULT NULL,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_site` AFTER UPDATE ON `pub_site` FOR EACH ROW BEGIN
  ...
  IF ((NEW.channel_order <=> OLD.channel_order) = 0) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created) 
      VALUES (31, NEW.site_id, 'channel', NOW());
  END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE TABLE `pub_slot` (
  ...
  `qa_language` enum('English','German','French','Spanish','Chinese','Japanese','Korean','Asian','Arabian','Other') DEFAULT 'English',
  `qa_device` enum('DeviceUnknown','DeviceMobile','DevicePC','DeviceTV','DevicePhone','DeviceTablet','DeviceConnected','DeviceSetTopBox') DEFAULT 'DeviceUnknown',
  `qa_position` enum('PositionUnknown','PositionAboveFold','PositionLocked','PositionBelowFold','PositionHeader','PositionFooter','PositionSideBar','PositionFullScreen') DEFAULT 'PositionUnknown',
  `qa_content` enum('ContentUnknown','ContentVideo','ContentGame','ContentMusic','ContentApp','ContentText','ContentOther') DEFAULT 'ContentUnknown',
  `fl_creative` set('AttrUnknown','AttrAudioAuto','AttrAudioUser','AttrExpandableAuto','AttrExpandableUserClick','AttrExpandableUserRollover','AttrVideoAuto','AttrVideoUser','AttrPop','AttrProvocative','AttrExtremeAnimation','AttrSurvey','AttrTextOnly','AttrInteractive','AttrWindowsDialog','AttrHasAudioToggleButton','AttrHasSkipButton','AttrFlash','AttrResponsive') DEFAULT 'AttrUnknown',
  `fl_mime` set('JsonMime','H5Mime','JSMime','ImageMime','VideoMime','AudioMime','MimeUnknown') DEFAULT 'JsonMime,H5Mime,JSMime,ImageMime,VideoMime,AudioMime,MimeUnknown',
  `created` datetime DEFAULT NULL,
  `active` enum('Yes','No','New') DEFAULT 'Yes',
  `mychannel` enum('Inherit','Own') DEFAULT 'Inherit',
  `channel_order` enum('White','Black','Inherit') DEFAULT 'Inherit',
  PRIMARY KEY (`slot_id`),
  KEY `size_id` (`size_id`),
  KEY `site_id` (`site_id`),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`eightran`@`localhost`*/ /*!50003 TRIGGER `trig_slot` AFTER UPDATE ON `pub_slot` FOR EACH ROW BEGIN

	IF ((NEW.active = "No") && (OLD.active = "Yes")) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created) 
      VALUES (32, NEW.slot_id, NEW.active, NOW());
  END IF;
  IF (((NEW.channel_order <=> OLD.channel_order) = 0) || ((NEW.mychannel <=> OLD.mychannel) = 0)) THEN
    INSERT INTO cron_halfhour (entitytype_id, entity_id, why, created) 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`eightran`@`localhost` PROCEDURE `proc_adv`(IN i_email VARCHAR(255), IN i_passwd VARCHAR(40), IN i_ip INT unsigned, OUT o_adv_id INT unsigned, OUT o_email VARCHAR(48), OUT o_company VARCHAR(255), OUT o_contact varchar(255), OUT o_timezone_id tinyint unsigned)
BEGIN
  DECLARE c1 INT;
  DECLARE c2 INT;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`eightran`@`localhost` PROCEDURE `proc_adv_as`(IN i_email VARCHAR(255), IN i_ip INT unsigned, OUT o_adv_id INT unsigned, OUT o_email VARCHAR(48), OUT o_company VARCHAR(255), OUT o_contact varchar(255), OUT o_timezone_id tinyint unsigned)
BEGIN
    SELECT p.adv_id, p.email, p.timezone_id, a.company, a.contact
    INTO o_adv_id, o_email, o_timezone_id, o_company, o_contact
    FROM adv p
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`eightran`@`localhost` PROCEDURE `proc_pub`(IN i_email VARCHAR(255), IN i_passwd VARCHAR(40), IN i_ip INT unsigned, OUT o_pub_id INT unsigned, OUT o_email VARCHAR(48), OUT o_company VARCHAR(255), OUT o_contact varchar(255), OUT o_timezone_id tinyint unsigned)
BEGIN
  DECLARE c1 INT;
  DECLARE c2 INT;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`eightran`@`localhost` PROCEDURE `proc_pub_as`(IN i_email VARCHAR(255), IN i_ip INT unsigned, OUT o_pub_id INT unsigned, OUT o_email VARCHAR(48), OUT o_company VARCHAR(255), OUT o_contact varchar(255), OUT o_timezone_id tinyint unsigned)
BEGIN
    SELECT p.pub_id, p.email, p.timezone_id, a.company, a.contact
    INTO o_pub_id, o_email, o_timezone_id, o_company, o_contact
    FROM pub p
...
/*!50013 DEFINER=`eightran`@`localhost` SQL SECURITY DEFINER */
